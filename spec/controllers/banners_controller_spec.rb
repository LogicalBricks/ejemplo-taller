...
describe BannersController do
  ...
  let(:valid_attributes) { { "archivo" => "MyString" , "url" => "http:\\algo", cliente_id: FactoryGirl.create(:cliente).id } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved banner as @banner" do
        ...
        post :create, {:banner => { "archivo" => "invalid value" }}, valid_session
        assigns(:banner).should be_a_new(Banner)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested banner" do
        ...
        Banner.any_instance.should_receive(:update).with({ "archivo" => "MyString" })
        put :update, {:id => banner.to_param, :banner => { "archivo" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the banner as @banner" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Banner.any_instance.stub(:save).and_return(false)
        put :update, {:id => banner.to_param, :banner => { "archivo" => "invalid value" }}, valid_session
        assigns(:banner).should eq(banner)
      end
