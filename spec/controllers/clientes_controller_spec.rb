...
describe ClientesController do
  ...
  let(:valid_attributes) { { rfc: "MyString", nombre_contacto: 'Jaime Pato', direccion: 'Calle principal #1 Centro', razon_social: 'Patito SA de CV', email: 'contacto@patito.com' } }
